package pk.edu.uog.systemsetting.controller;
...
import pk.edu.uog.datalogs.model.tableDataLogs;
import pk.edu.uog.datalogs.repository.apiRequestDataLogRepository;
import pk.edu.uog.datalogs.repository.databaseTablesRepository;
import pk.edu.uog.datalogs.repository.tableDataLogRepository;
import pk.edu.uog.login.model.LoginUser;
import pk.edu.uog.login.repository.loginUserRepository;
import pk.edu.uog.systemsetting.model.Lookup;
import pk.edu.uog.systemsetting.repository.lookupRepository;
import pk.edu.uog.token.AccessToken;
