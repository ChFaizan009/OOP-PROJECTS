...
public class CommunicationService {
	...
	public static String GenerateAndSendLetter(String letterCode, long applicationID, LoginUser loginuser, boolean sendEmail, LoginUser emailUser)
			throws JsonProcessingException, JSONException, ParseException {
